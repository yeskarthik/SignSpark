...
- **Mobile playback** — touch devices skip offscreen YouTube iframe preloading while retaining the same automatic muted looping and startup recovery as desktop.
