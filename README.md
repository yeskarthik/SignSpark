...
- **Phone-safe playback** — mobile devices use eager, muted inline YouTube embeds with a cross-origin referrer policy that satisfies YouTube player identity checks on WebKit
