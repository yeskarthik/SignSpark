...
- **Phone-safe playback** — mobile devices use standard interactive YouTube players with visible controls and correct cross-origin identity; one tap starts playback reliably on WebKit
