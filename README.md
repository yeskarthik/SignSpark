...
- **Phone-safe playback** — mobile devices use tappable YouTube players with hidden controls and correct cross-origin identity; one tap starts playback reliably on WebKit
